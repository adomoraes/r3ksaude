						...
						<div className='flex flex-col lg:grid lg:grid-cols-4 lg:grid-rows-2 mt-10'>
							...
							<div className='bg-blue-950 text-white p-4 flex-1 lg:col-span-1 lg:w-full'>
								...
								<p>
									...
									compartilhou suas experiências sobre a realidade dos pacientes
									e destacou a importância do trabalho de sua instituição, que
									busca garantir soluções para quem conviver com patologias
									raras.
								</p>
							</div>
						</div>
