							...
							<div className='md:basis-3/5 p-4'>
								<div className='text-left'>
									...
									<p className='mt-6 text-lg leading-8 text-white w-4/5'>
										...
										de fornecer informações atualizadas e confiáveis à população
										sobre saúde.
									</p>
									<h1
										style={{
							...
							<div className='md:basis-2/5 p-4'>
								<div className='text-left'>
									...
									<p className='mt-6 text-lg leading-8 text-white'>
										...
										objetivo é democratizar o conhecimento de forma acessível ao
										público geral, ajudando a esclarecer dúvidas e desmistificar
										conceitos relacionados à saúde preventiva, vacinação,
										epidemiologia, entre outros temas da atualidade.
									</p>
								</div>
							</div>
						</div>
