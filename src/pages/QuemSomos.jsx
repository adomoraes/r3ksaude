					...
					<div className='flex flex-col md:flex-row'>
						<div className='md:basis-1/4 p-4'>
							<div className='text-left'>
								...
								<p className='mt-6 text-lg leading-8 text-blue-950'>
									...
									(SBIm) e ex-presidente da entre 2011 e 2014, especializado em
									pediatria e neonatologia no Hospital do Servidor Público
									Estadual e em infectologia pediátrica na Sociedade Brasileira
									de Pediatria (SBP).
								</p>
						...
						<div className='md:basis-1/4 p-4'>
							<div className='text-left'>
								...
								<p className='mt-6 text-lg leading-8 text-blue-950'>
									É infectologista do Instituto de Infectologia Emilio Ribas, em
									São Paulo, desde 1988. Ex-presidente da Sociedade Paulista de
									Infectologia (SPI) 2011-2012 e Diretora do Comite de
									Imunização da Sociedade Brasileira de Infectologia (2019/20).
								</p>
								<div className='flex lg:flex-1 justify-center lg:justify-start mt-10 text-rose-700'>
									<a
										href='https://www.instagram.com'
